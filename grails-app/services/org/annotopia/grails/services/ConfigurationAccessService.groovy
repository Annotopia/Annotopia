...
class ConfigurationAccessService {
	...
	public String getAdministratorOrganization() {
		try {
			return (grailsApplication.config.annotopia.admin.organization);
		} catch (Exception e) {
	...
	public boolean doesAdministratorEmailAddressExists() {
		try {
			return (grailsApplication.config.annotopia.admin.email.address && grailsApplication.config.annotopia.admin.email.address.length()>0);
		} catch (Exception e) {
	...
	public String getAdministratorEmailAddress() {
		if(doesAdministratorEmailAddressExists()) {
			return grailsApplication.config.annotopia.admin.email.to;
		} else {
	...
	public String getAdministratorEmailLabel() {
		try {
			return grailsApplication.config.annotopia.admin.email.display;
		} catch (Exception e) {
