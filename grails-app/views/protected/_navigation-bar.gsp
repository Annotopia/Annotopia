...
<nav class="navbar navbar-w3r " role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<g:link controller="protected" action="index" class="navbar-brand">
		...
		<div class="navbar-collapse collapse navbar-right">
			<ul class="nav navbar-nav">
				...
				<li><g:link controller="protected" action="search">Search</g:link></li>	
				<li><g:link controller="protected" action="annotations">Annotations</g:link></li>		
				<li><g:link controller="protected" action="profile">My profile</g:link></li>	
